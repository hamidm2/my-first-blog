$( document ).ready(function() {
  // Main variables
    ...
    var $developmentWrapper1 = $('.development-wrapper1');
  ...
  /* ##### EDUCATION SECTION #### */
      ...
      // Check the location of each element hidden */
      $('.education .content .hidden').each( function(i){
  ...
  /*###### SKILLS SECTION ######*/
    ...
    if((bottom_of_window > middle_of_developmentWrapper)&& (developmentIsVisible == false)){
      ...
      var middle_of_developmentWrapper = $developmentWrapper1.offset().top + $developmentWrapper1.outerHeight()/2;
